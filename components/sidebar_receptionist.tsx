...
export function Receptionist_Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    // },
    {
      ...
      icon: Users,
      submenu: [
        { title: "Doctors List", href: "/receptionist-dashboard/doctors" },
    ...
    // },
    {
      ...
      icon: Calendar,
      submenu: [
        { title: "All Appointments", href: "/receptionist-dashboard/appointments" },
        // { title: "Add Appointment", href: "/appointments/add" },
        { title: "Calendar View", href: "/receptionist-dashboard/appointments/calendar" },
    ...
    },
    {
      ...
      icon: Settings,
      submenu: [
        { title: "General Settings", href: "/rec-dashboard/settings" },
